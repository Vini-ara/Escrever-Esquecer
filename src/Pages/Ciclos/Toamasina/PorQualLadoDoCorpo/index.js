  ...
  return (
    <div className={`${styles.container} ${transition ? styles.transition : ''}`}>
      ...
      <section className={styles.wrapper}>
        ...
        <hr/>
        <p>
          <strong>Por qual lado do corpo se começa a conhecer uma pessoa?</strong> Ou por qual lado de sua voz? Existe voz dentro de uma pessoa? Existe mesmo a pessoa por baixo da voz? 
        </p>
        ...
        <p>
          Ou por qual de suas palavras? Você escapa de mim, e escapará sempre. <em>Eu</em> sei disso, mas, e mesmo por isso, <em>eu</em> te persigo. Como uma raiz que afunda na terra, indefinidamente. Ou como uns olhos que, a despeito do horror dos dias, insistem em figurar nas nuvens um contorno. Isto <em>nunca</em> vai ter fim. Não procuro razão nas sementes, nem intenção na chuva. Não enxergo na vida qualquer propósito. Sei que passa também por isso – e neste século mesmo digo – o amor. O que <em>eu</em> chamaria, é verdade, de amor. Um esforço gratuito de fazer com que o corpo valha todas as suas penas. Que não cessam jamais de se revelar, de nos impor aquilo que os desavisados sussurram com as costas das mãos, pelo negativo: sim, o amor é um destino. 
        </p>
        ...
        <p>
          As florestas, quando as sobrevoamos nas noites insones, quando as vimos refletidas no céu estrelado, se moviam para perto e para longe ao mesmo tempo, para dentro e para fora de si mesmas. Eram inapreensíveis, as florestas, fundando aos nossos olhos também um destino, uma beira: ainda a perda. Você dormindo se move para longe e para perto de mim, da mesma maneira. Você balbucia palavras que desconheço, você esboça gestos ainda inéditos, seu corpo é como um eco que ressoa a si mesmo. Disto escolherei não <em>me</em> esquecer, mesmo que saiba da inutilidade deste desejo. O que restará decantado, no fundo de minha cabeça, quando um dia isto tudo finde? O que me permite ignorar a ausência de certezas e seguir a esperar que em minhas mãos algo permaneça, ao menos como risco, até o fim de meus poucos dias? Se o vazio for mesmo onde se erguem todas as catedrais e savanas, se de fato é em um ponto surdo que te ouço e te pressinto, e se é pelo espaço que se iniciam todos os gestos, como posso <em>não</em> trair a tua existência no instante em que sou fiel a meu desejo?
        </p>
        ...
        <p>
          Por isso desconheço teu corpo. Não sei ao certo onde situá-lo nisso tudo. Não posso supor que ele comece exatamente onde terminam minhas mãos. Como não há continuação visível entre terra, folha, semente, e fruto. É tudo distinto, e é tudo também o mesmo. Seu corpo começa onde começa meu destino. Isto é, no curso de minha vida, mesmo naquilo que é totalmente alheio à sua existência, mesmo naquele espaço em que minha vida não se deu ainda. <em>Eu</em> não sei onde fica esta encruzilhada. E não sei sequer em que <em>pensava</em> quando parti em busca de situá-la em mim, em ti, ou no mundo. A busca é o outro, sempre foi e sempre deveria ter sido. Seu corpo acaba também onde começa meu destino. <em>Eu</em> não sei o que te digo.
        </p>
        ...
        <p className={styles.end}>
          <em>
            Mas como dizer que sua dor é a minha sem que eu diga que é meu o seu corpo? Como dizer que eu sei o que você sente sem que eu tenha agora o seu nome? Como é possível se sentir em casa quando o mundo apodrece e renasce a cada segundo dentro e fora de seus olhos? <span>Eu</span> não sei o que é uma pessoa e muito menos o que são duas. <span>Eu</span> não sei que Estado é este que acidentalmente criamos juntos. <span>Eu</span> não entendo onde se escrevem e sobre quem agem essas leis. <span>Eu</span> permito que você me ame. Nisto está dada enfim uma resposta ou uma diretriz? Isto instaura uma normalidade diante do absurdo que é dizer <span>eu</span>? Isto cria um acontecimento à beira do abismo? Cessarão de nascer as plantas nas quinas da casa apenas porque nós nos amamos? No fundo, isto é sobre como pode ser possível ser e não ser real. Sobre como sentir é algo virtual, mas que se forma apenas debaixo de rios de sangue. São reais as florestas que nunca vimos? São reais as canções que nunca tocamos? Estão mortas as pessoas das quais não mais soubemos? Todos têm uma resposta definitiva para isso. O corpo, no entanto, segue sem alegar os seus motivos. <span>Eu</span> permito que você me ame. <span>Eu</span> ordeno que você me ame. <span>Eu</span> prometo que nascerão as sementes. <span>Eu</span> juro que meu corpo reage a teu corpo. E eu o digo sem nenhum remorso: mas, e então? O que é uma pessoa, o que podem ser duas? O que podem ser duzentas e cinquenta? Ou duzentas milhões? Se me parece impossível falar sobre <span>eu</span> e você, como se pode falar de um bairro ou de um país? Por que frestas, fendas e nós passa minha voz? Resvala esta voz em algum dos corpos que ela tenta alegar ou defender? Você está me escutando agora? Com quantos absurdos se faz um precedente? Deve haver algo entre as pessoas que não sejam apenas os empurrões em escadas estreitas ou os insultos em avenidas empoeiradas. Deve haver algo entre <span>eu</span> e você que não seja o intervalo em que um corpo cede seu espaço a outro corpo. Que mediação impossível é esta? <span>Eu</span> te permito amar outra pessoa. <span>Eu</span> ordeno que você ame todas as pessoas que existam. <span>Eu</span> prometo que todas as plantas te amarão. Parece que os dias nada nos ensinam. As florestas amam umas às outras? Os cães preenchem seus coitos com amor? Amam os cães as florestas? O mundo parece ter passado muito bem sem esses problemas. Sem que o corpo e o corpo se diferenciassem em um sopro. As flores não são vermelhas azuis ou amarelas salvo se as imaginamos em nossas mãos ou nas mãos de quem nós amamos. (Nas demais mãos sequer imaginamos). Têm irrompido animais que voam, que nadam, que rastejam, que pulam, que correm, que escavam, que hibernam, que morrem. Têm rebentado plantas que beijam o sol, que não se descolam do solo, que naufragam na noite da terra, que formam bulbos, estipes, folhas, espinhos, pecíolos, e que morrem. Independentemente destes nomes que <span>eu</span> aqui elenque, mas sem os quais você não entenderia o que <span>eu</span> estou pensando agora. <span>Eu</span> ordeno que você entenda. Pisamos no mundo e falamos o mundo, e ele não parece carecer de nossas vozes. O que é uma pessoa? O que são duas ou duas bilhões de pessoas andando sobre o mundo e sendo-o?Por onde começar a procurá-las? <span>Eu</span> ordeno que você esqueça.
          </em>
        </p>
